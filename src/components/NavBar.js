            ...
            <div className={styles["bottom-div"]}>
                <div className={styles["text-box"]}>
                    ...
                    <p>
                        ...
                        <br />
                        with Reliable Shipping and Cashflow.
                    </p>
                    <form>
                        <div className={styles["form-top-text"]}> Talk to us now! </div>
                        <div className={styles["form-div"]}>
                                <div className={styles["whatsapp-icon-box"]}>
                                        <div>
                                        ...
                                        <div className={styles["arrow-down-svg"]}>
                                ...
                                <div className={styles["whatsapp-number-input-box"]}>
                                    <input type="number" placeholder="Whatsapp number" name="mobile_number"></input>
                                    <button>
                                        <div> Get Started </div>
                                    </button>
                                </div>
                ...
                <video loop autoPlay muted height="500" src="https://cdn.cogoport.io/cms-prod/cogo_public/vault/original/mobile-track-shipment.webm" poster="https://cdn.cogoport.io/cms-prod/cogo_public/vault/original/final_static_chat_girl_img.png">
                    {/* <source src="https://cdn.cogoport.io/cms-prod/cogo_public/vault/original/mobile-track-shipment.webm" type="video/webm"></source> */}
                </video>
            </div>
        </div>
    </div>
